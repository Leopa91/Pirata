unit drv_unit;
 ...
 Function IC_Erase(idComDev:longint;offset,len:smallint):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_Erase';
 ...
 Function IC_CheckWPassword_Hex(idComDev:longint;zone:smallint;password:pchar):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_CheckWPassword_Hex';
 function IC_WriteUserZone(icCOmDev:longint;offset:smallint;len:longint;data:pchar):smallint;stdcall;
 far;external'Dcic32.dll'name 'IC_WriteUserZone' ;
 function IC_ReadUserZone(icCOmDev:longint;offset:smallint;len:longint;data:pchar):smallint;stdcall;
 far;external'Dcic32.dll'name 'IC_ReadUserZone' ;
 function IC_SetUserZone(idcomdev:longint;zone:smallint):smallint;stdcall;
 far;external 'Dcic32.dll'name 'IC_SetUserZone' ;
 function IC_ReadConfigeZone(icCOmDev:longint;offset:smallint;len:longint;data:pchar):smallint;stdcall;
 far;external'Dcic32.dll'name 'IC_ReadConfigeZone' ;
 function IC_ReadWPasswordCount(icCOmDev:longint;zone:longint):smallint;stdcall;
 far;external'Dcic32.dll'name 'IC_ReadWPasswordCount' ;
