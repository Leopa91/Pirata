unit drv_unit;
 ...
 Function IC_InitComm_Baud(port:smallint;banu:longint):longint;stdcall;
 far;external 'Dcic32.dll' name 'IC_InitComm_Baud';
 ...
 Function IC_Check_4442(idComDev:longint):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_Check_4442';

 Function IC_Check_4428(idComDev:longint):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_Check_4428';


 Function IC_ReadDevice(idComDev:longint;offset,len:smallint;databuffer:pchar):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_ReadDevice';
 Function IC_WriteDevice(idComDev:longint;offset,len:smallint;databuffer:pchar):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_WriteDevice';
 Function IC_ReadDevice_Hex(idComDev:longint;offset,len:smallint;databuffer:pchar):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_ReadDevice_Hex';
 Function IC_WriteDevice_Hex(idComDev:longint;offset,len:smallint;databuffer:pchar):smallint;stdcall;
 far;external 'Dcic32.dll' name 'IC_WriteDevice_Hex';
