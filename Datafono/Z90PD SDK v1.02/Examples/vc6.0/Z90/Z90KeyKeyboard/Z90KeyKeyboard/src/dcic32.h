...
//AT88SC1608 卡的专用函数
	...
	*/
	...
	__int16 __stdcall IC_InstallKbKeyPro(HANDLE idComDev,unsigned char flag,unsigned char keylen, unsigned char * keydata,unsigned char mode);
	__int16 __stdcall IC_InstallKbKeyPro_Hex(HANDLE idComDev,unsigned char flag,unsigned char keylen, unsigned char * keydata,unsigned char mode);
	__int16 __stdcall IC_CreatDesData(HANDLE idComDev,unsigned char keytype,unsigned char enmode,unsigned char * sourcedata,unsigned char * retdata);
	__int16 __stdcall IC_CreatDesData_Hex(HANDLE idComDev,unsigned char keytype,unsigned char enmode,unsigned char * sourcedata,unsigned char * retdata);
	...
	__int16 __stdcall IC_CreatMacECB(HANDLE idComDev,unsigned short slen,unsigned char *sourcedata,unsigned char *retdata);
