...
extern "C" {
	...
	__int16 __stdcall IC_Reset(HANDLE idComDev);
	...
	*/
	...
	__int16 __stdcall IC_TypeA_Cpu_Reset_Hex(HANDLE icdev, unsigned char _Mode, unsigned char *rlen, unsigned char *receive_data);
	__int16 __stdcall IC_TypeA_Cpu_Reset(HANDLE icdev, unsigned char _Mode, unsigned char *rlen, unsigned char *receive_data);
	...
	__int16 __stdcall IC_SetUldPpsMode(HANDLE idComDev, unsigned char bs);
	__int16 __stdcall IC_PlayVoice(HANDLE idComDev, unsigned char _modeVoice);
	
	
	//-----------------------------以下为特殊用途的定制函数，可以根据需要选用或者删除-------------------
	//----------------------------------------------------------------------------------------------
	//山东社保神思定制读写器函数两条。 SD_SendToPos 
	__int16 __stdcall SD_SendToPos(HANDLE idComDev, unsigned char pplen, unsigned char * ppdata);
	__int16 __stdcall SD_GetFromPos(HANDLE idComDev, unsigned char * rlen, unsigned char * ppdata, unsigned char timeout);
	
	//
	__int16 __stdcall IC_GetUsbID(unsigned int *VendorID, unsigned int *ProductID);
	...
	__int16 __stdcall IC_Pro_Commandlinkhex(HANDLE idComDev, unsigned int slen, 
		...
		unsigned char * databuffer, unsigned char timeout, 
		unsigned char FG);
	__int16 __stdcall IC_InstallKbKey(HANDLE idComDev, unsigned char flag, unsigned char keylen, 
		unsigned char * keydata);
	__int16 __stdcall IC_GetEnPass(HANDLE idComDev, unsigned char ctime, unsigned char panlen, unsigned char * pandata, 
		unsigned char *rlen, unsigned char * cpass);
	__int16 __stdcall IC_CreatMacData(HANDLE idComDev, unsigned short DataLen, unsigned char *SourceData, unsigned char *MacData);
	__int16 __stdcall IC_SetKbKeyID(HANDLE idComDev, unsigned char keyID);
	
	__int16 __stdcall DEV_SendCommandMcu(HANDLE idComDev, unsigned char ctimeout, unsigned char slen, unsigned char * sendbuffer);
	__int16 __stdcall DEV_SendCommandMcu_Hex(HANDLE idComDev, unsigned char ctimeout, unsigned char slen, unsigned char * sendbuffer);
	...
	__int16 __stdcall IC_CpuApduEn(HANDLE idComDev,unsigned char slen,unsigned char * sendbuffer,unsigned char *rlen,unsigned char * databuffer);
	__int16 __stdcall IC_CpuApduEn_Hex(HANDLE idComDev,unsigned char slen,unsigned char * sendbuffer,unsigned char *rlen,unsigned char * databuffer);

	__int16 __stdcall IC_WriteUserData(HANDLE idComDev,unsigned int offset,unsigned int len,unsigned char *writebuffer);
	__int16 __stdcall IC_WriteUserData_Hex(HANDLE idComDev,unsigned int offset,unsigned int len,unsigned char *writebuffer);
	__int16 __stdcall IC_ReadUserData(HANDLE idComDev,unsigned int offset,unsigned int len,unsigned char * databuffer);
	__int16 __stdcall IC_ReadUserData_Hex(HANDLE idComDev,unsigned int offset,unsigned int len,unsigned char * databuffer);
	__int16 __stdcall IC_EarseUserData(HANDLE idComDev,unsigned char userzone);
	__int16 __stdcall IC_PassGetEn(HANDLE idComDev,unsigned char panlen,unsigned char * pandata,
								 unsigned char *rlen,unsigned char * cpass);
	...
	__int16 __stdcall IC_IFD_GetEnPINPro(HANDLE icdev,char *szPasswd,unsigned char yyflag,unsigned char modeflag,unsigned char timeout);
	__int16 __stdcall IC_IFD_GetEnPINBlock(HANDLE icdev,char *szPasswd,unsigned char yyflag,unsigned char modeflag,unsigned char *cardno,unsigned char timeout);
	__int16 __stdcall IC_IFD_Init(HANDLE icdev);
	__int16 __stdcall IC_IFD_SetMainKey(HANDLE icdev,unsigned char keyset,unsigned char *oldkey,unsigned char *newkey);
	__int16 __stdcall IC_IFD_SetWorkKey(HANDLE icdev,unsigned char keysetmain,unsigned char keysetwork,unsigned char *enkeywork);
	__int16 __stdcall IC_IFD_ActWorkKey(HANDLE icdev,unsigned char keysetmain,unsigned char keysetwork);
	__int16 __stdcall IC_IFD_SetKeyLength(HANDLE icdev,unsigned char keylength);
	//__int16 __stdcall IC_IFD_GetVer(HANDLE icdev,unsigned char* Ver);

	__int16 __stdcall IC_CtlVoltage(HANDLE idComDev, unsigned char cValue);
	__int16 __stdcall IC_CpuApduResponEXT(HANDLE idComDev,__int16 slen,unsigned char * sendbuffer,__int16 *rlen,unsigned char * databuffer);
	__int16 __stdcall IC_CpuApduResponEXT_Hex(HANDLE idComDev,__int16 slen,unsigned char * sendbuffer,__int16 *rlen,unsigned char * databuffer);
	__int16 __stdcall IC_WriteAllEeprom(HANDLE idComDev,__int16 Offset,__int16 len,unsigned char *writebuffer);
	// __int16 __stdcall dc_pro_findcard(HANDLE idComDev,unsigned int slen,unsigned char * sendbuffer,unsigned int *rlen,unsigned char * databuffer,unsigned char timeout,unsigned char FG);
#ifdef __cplusplus
}
#endif
