...
int  IC_GetInputPass(int idComDev,unsigned char ctime,unsigned char *rlen,unsigned char * cpass);
...
int  IC_ReadMagCardAll(int idComDev, unsigned char ctime, unsigned char *pTrack1Data, unsigned long *pTrack1Len, unsigned char *pTrack2Data, unsigned long *pTrack2Len, unsigned char *pTrack3Data, unsigned long *pTrack3Len);
