...
Declare Function IC_DirectReadhex% Lib "DCIC32.DLL" Alias "IC_DirectRead" (ByVal icdev As Long, ByVal page%, ByVal offset%, ByVal bytes%, ByRef buff As Byte)
Declare Function IC_DirectWritehex% Lib "DCIC32.DLL" Alias "IC_DirectWrite" (ByVal icdev As Long, ByVal page%, ByVal offset%, ByVal bytes%, buff As Byte)
