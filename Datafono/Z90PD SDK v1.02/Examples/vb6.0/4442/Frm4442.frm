...
DoEvents
    ...
    If Mid(WriteStr, 1, Length * 2) = Mid(ReadStr, 1, Length * 2) Then
      List1.AddItem "写随机数 Comp Read Data and Write Data OK!"
    Else
      List1.AddItem "写随机数 Comp Read Data and Write Data Error!"
    End If
    DoEvents
   ...
   WrDataStr = "请写入数据1234gh"
    ...
    If Mid(ReDataStr, 1, Length) = Mid(WrDataStr, 1, Length) Then
      List1.AddItem "写中文 Comp Read Data and Write Data OK!"
    Else
      List1.AddItem "写中文 Comp Read Data and Write Data Error!"
    End If
    DoEvents
    List1.Selected(List1.ListCount() - 1) = True
'*********************读写保护位****************
